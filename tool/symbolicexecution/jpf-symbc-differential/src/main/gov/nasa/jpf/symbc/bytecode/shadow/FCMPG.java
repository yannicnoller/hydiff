        ...
        if ((op_v1 == null) && (op_v2 == null)) { // both conditions are concrete
            ...
            if (!th.isFirstStepInsn()) {
                ...
                if (SymbolicInstructionFactory.collect_constraints) {
                    ...
                    int oldCon_conditVal = super.conditionValue((float) oldCon_v1.solution(),
                            (float) oldCon_v2.solution());
                    int newCon_conditVal = super.conditionValue((float) newCon_v1.solution(),
                            (float) newCon_v2.solution());
