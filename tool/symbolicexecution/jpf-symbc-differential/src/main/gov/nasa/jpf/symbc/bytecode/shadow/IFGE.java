            ...
            if (!ti.isFirstStepInsn()) {
                ...
                if (SymbolicInstructionFactory.collect_constraints) {
                    ...
                    if (pc.isDiffPC()) {
                        ...
                        pc._addDet(newConcrete_result ? Comparator.GE : Comparator.LT, newSym_v, 0);
                        ...
                        if (ti.getExecutionMode() == Execute.OLD) {
                            pc._addDet(oldConcrete_result ? Comparator.GE : Comparator.LT, oldSym_v, 0);
                    ...
                    case 3: // Diff false path in src (new false, old true)
                        ...
                        return this.getTarget(); // continue with new version
                    default:
                        throw new RuntimeException("Unhandled choice in IFGE: " + choice);
                    }
                }
            }
        }
