...
public class INVOKESPECIAL extends gov.nasa.jpf.jvm.bytecode.INVOKESPECIAL {
	...
	public Instruction execute(ThreadInfo th) {
	    ...
	    if (SymbolicInstructionFactory.shadowSymExeMode) {
	    	nextInstr = gov.nasa.jpf.symbc.bytecode.shadow.ShadowBytecodeUtils.execute(this, th);
	    } else {
	    	nextInstr = BytecodeUtils.execute(this, th);
	    }
