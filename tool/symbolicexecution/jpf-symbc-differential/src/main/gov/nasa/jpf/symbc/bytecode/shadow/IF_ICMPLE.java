            ...
            if (!ti.isFirstStepInsn()) {
                ...
                if (SymbolicInstructionFactory.collect_constraints) {
                    ...
                    if (pc.isDiffPC()) {
                        ...
                        pc._addDet(newConcrete_result ? Comparator.LE : Comparator.GT, newSym_v1, newSym_v2);
                        ...
                        if (ti.getExecutionMode() == Execute.OLD) {
                            pc._addDet(oldConcrete_result ? Comparator.LE : Comparator.GT, oldSym_v1, oldSym_v2);
                    ...
                    default:
                        throw new RuntimeException("Unhandled choice in IF_ICMPLE: " + choice);
                    }
                }
            }
        }
