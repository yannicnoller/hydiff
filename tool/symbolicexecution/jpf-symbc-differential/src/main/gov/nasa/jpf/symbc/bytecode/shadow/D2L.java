...
public class D2L extends gov.nasa.jpf.jvm.bytecode.D2L {
    ...
    public Instruction execute(ThreadInfo th) {
        Object sym_dval = th.getModifiableTopFrame().getLongOperandAttr();
        ...
        if (sym_dval == null) {
            ...
            if (sym_dval instanceof DiffExpression) {
                ...
                DiffExpression result_lval = new DiffExpression(oldSym_longValue, newSym_longValue, oldCon_longValue, newCon_longValue);
