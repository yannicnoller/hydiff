        ...
        if (!(op_v == null && ti.getExecutionMode() == Execute.BOTH)) {
            ...
            if (ti.getExecutionMode() == Execute.OLD || ti.getExecutionMode() == Execute.BOTH) {
                ...
                if (oldSym_v instanceof IntegerConstant) {
                    oldSym_result = new IntegerConstant(-oldSym_v.solutionInt());
                } else {
                    oldSym_result = oldSym_v._neg();
                }
                oldCon_result = new IntegerConstant(-oldCon_v.solutionInt());
            }
            ...
            if (ti.getExecutionMode() == Execute.NEW || ti.getExecutionMode() == Execute.BOTH) {
                ...
                if (newSym_v instanceof IntegerConstant) {
                    newSym_result = new IntegerConstant(-newSym_v.solutionInt());
                } else {
                    newSym_result = newSym_v._neg();
                }
                newCon_result = new IntegerConstant(-newCon_v.solutionInt());
            }
