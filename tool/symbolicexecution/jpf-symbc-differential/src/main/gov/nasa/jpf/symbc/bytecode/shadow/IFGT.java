...
//A PARTICULAR PURPOSE, OR FREEDOM FROM INFRINGTMENT, ANY WARRANTY THAT
            ...
            if (!ti.isFirstStepInsn()) {
                ...
                if (SymbolicInstructionFactory.collect_constraints) {
                    ...
                    if (pc.isDiffPC()) {
                        ...
                        pc._addDet(newConcrete_result ? Comparator.GT : Comparator.LE, newSym_v, 0);
                        ...
                        if (ti.getExecutionMode() == Execute.OLD) {
                            pc._addDet(oldConcrete_result ? Comparator.GT : Comparator.LE, oldSym_v, 0);
                    ...
                    case 3: // Diff false path in src (new false, old true)
                        ...
                        return this.getTarget(); // continue with new version
                    default:
                        throw new RuntimeException("Unhandled choice in IFGT: " + choice);
                    }
                }
            }
        }
