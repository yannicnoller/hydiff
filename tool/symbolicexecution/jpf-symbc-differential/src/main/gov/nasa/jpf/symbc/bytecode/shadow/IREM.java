    ...
    public Instruction execute(ThreadInfo ti) {
        ...
        if (!ti.isFirstStepInsn()) { // first time around
            ...
            if (SymbolicInstructionFactory.collect_constraints) {
                ...
                boolean oldV1IsZero = oldCon_v1.solutionInt() == 0;
                boolean newV1IsZero = newCon_v1.solutionInt() == 0;
                ...
                if (pc.isDiffPC()) {
                    if (!newV1IsZero) {
                        ...
                        curCg.setCurrentPC(pc);
                        return ti.createAndThrowException("java.lang.ArithmeticException", "rem by 0");
                    }
                    ...
                    if (ti.getExecutionMode() == Execute.OLD) {
                        if (!oldV1IsZero) {
                            ...
                            pc.markAsDiffPC(this.getLineNumber(), Diff.divByZero);
                            curCg.setCurrentPC(pc);
                            ShadowPCChoiceGenerator shadowCg = curCg.getPreviousChoiceGeneratorOfType(ShadowPCChoiceGenerator.class);
                            if (shadowCg != null) {
