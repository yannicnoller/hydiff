...
public class JarFileIO {
     ...
     */
    public static void extractJar(String file, HashSet<String> classes, HashSet<String> inputClassesFullPath) {
        try {
            // open JAR file
            ...
            while (entries.hasMoreElements()) {
                ...
                if (entryName.endsWith(".class")) {
                    ...
                    inputClassesFullPath.add(entryName.substring(0, entryName.length()-6));
                } else if (entryName.endsWith(".jar")) {
                    // load nested JAR
                    // extractJar(file + "/" + entryName, classes); TODO YN: skip for now
                }
            }
