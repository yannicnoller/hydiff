...
public class TCAS_V9 {
	...
	private boolean Non_Crossing_Biased_Climb(){
	    ...
	    upward_preferred = change(Inhibit_Biased_Climb() > Down_Separation, Inhibit_Biased_Climb() >= Down_Separation); /* operator mutation change > to >= */
	    if (upward_preferred){
