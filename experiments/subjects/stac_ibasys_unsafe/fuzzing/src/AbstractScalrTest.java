...
public abstract class AbstractScalrTest {
    ...
    protected static BufferedImage load(byte[] data) {
        ...
        try {
            ...
            // TODO YN: changed how to read the BufferedImage for SPF (and to make sure that the same input is read in
            // both fuzzing and symexe, we also adjusted this part here.
