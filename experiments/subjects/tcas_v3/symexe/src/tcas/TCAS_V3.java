...
public class TCAS_V3 {
	...
	int alt_sep_test(){
	    ...
	    intent_not_known = change(Two_of_Three_Reports_Valid && Other_RAC == NO_INTENT, Two_of_Three_Reports_Valid || Other_RAC == NO_INTENT); /* logic change && to || */
