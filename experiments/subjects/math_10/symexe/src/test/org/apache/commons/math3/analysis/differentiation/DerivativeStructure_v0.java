 ...
 * <p>{@link DerivativeStructure_v0} instances can be used directly thanks to
 ...
 * the {@link DerivativeStructure_v0}-based instances.</p>
 * <p>Instances of this class are guaranteed to be immutable.</p>
 * @see DSCompiler_v0
 * @version $Id$
 * @since 3.1
 */
public class DerivativeStructure_v0 implements FieldElement<DerivativeStructure_v0>, Serializable {

    /** Serializable UID. */
    private static final long serialVersionUID = 20120730L;

    /** Compiler for the current dimensions. */
    private transient DSCompiler_v0 compiler;
     ...
     */
    private DerivativeStructure_v0(final DSCompiler_v0 compiler) {
     ...
     */
    public DerivativeStructure_v0(final int variables, final int order) {
        this(DSCompiler_v0.getCompiler(variables, order));
    }
     ...
     */
    public DerivativeStructure_v0(final int variables, final int order, final double value) {
    ...
    public DerivativeStructure_v0(final int variables, final int order,
        ...
        if (order > 0) {
            ...
            data[DSCompiler_v0.getCompiler(index, order).getSize()] = 1.0;
        }
     ...
     */
    public DerivativeStructure_v0(final double a1, final DerivativeStructure_v0 ds1,
                               final double a2, final DerivativeStructure_v0 ds2)
    ...
    public DerivativeStructure_v0(final double a1, final DerivativeStructure_v0 ds1,
                               final double a2, final DerivativeStructure_v0 ds2,
                               final double a3, final DerivativeStructure_v0 ds3)
        throws DimensionMismatchException {
        this(ds1.compiler);
        compiler.checkCompatibility(ds2.compiler);
    ...
    public DerivativeStructure_v0(final double a1, final DerivativeStructure_v0 ds1,
                               final double a2, final DerivativeStructure_v0 ds2,
                               final double a3, final DerivativeStructure_v0 ds3,
                               final double a4, final DerivativeStructure_v0 ds4)
        throws DimensionMismatchException {
        this(ds1.compiler);
        compiler.checkCompatibility(ds2.compiler);
        compiler.checkCompatibility(ds3.compiler);
     ...
     */
    private DerivativeStructure_v0(final DerivativeStructure_v0 ds) {
     ...
     * @return this+a
     */
    public DerivativeStructure_v0 add(final double a) {
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(this);
        ds.data[0] += a;
        return ds;
    }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 add(final DerivativeStructure_v0 a)
        throws DimensionMismatchException {
     ...
     * @return this-a
     */
    public DerivativeStructure_v0 subtract(final double a) {
        return add(-a);
    }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 subtract(final DerivativeStructure_v0 a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(this);
    ...
    /** {@inheritDoc} */
    public DerivativeStructure_v0 multiply(final int n) {
     ...
     * @return this&times;a
     */
    public DerivativeStructure_v0 multiply(final double a) {
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(this);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 multiply(final DerivativeStructure_v0 a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     */
    public DerivativeStructure_v0 divide(final double a) {
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(this);
        for (int i = 0; i < ds.data.length; ++i) {
            ds.data[i] /= a;
        }
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 divide(final DerivativeStructure_v0 a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return this%a
     */
    public DerivativeStructure_v0 remainder(final double a) {
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(this);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 remainder(final DerivativeStructure_v0 a)
        throws DimensionMismatchException {
        compiler.checkCompatibility(a.compiler);
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return -this
     */
    public DerivativeStructure_v0 negate() {
        final DerivativeStructure_v0 ds = new DerivativeStructure_v0(compiler);
        for (int i = 0; i < ds.data.length; ++i) {
            ds.data[i] = -data[i];
        }
        return ds;
    ...
    /** {@inheritDoc} */
    public DerivativeStructure_v0 reciprocal() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     */
    public DerivativeStructure_v0 sqrt() {
        return rootN(2);
    }
     ...
     */
    public DerivativeStructure_v0 cbrt() {
        return rootN(3);
    }
     ...
     */
    public DerivativeStructure_v0 rootN(final int n) {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
    ...
    /** {@inheritDoc} */
    public Field<DerivativeStructure_v0> getField() {
        return new Field<DerivativeStructure_v0>() {

            /** {@inheritDoc} */
            public DerivativeStructure_v0 getZero() {
                return new DerivativeStructure_v0(compiler.getFreeParameters(), compiler.getOrder(), 0.0);
            }

            /** {@inheritDoc} */
            public DerivativeStructure_v0 getOne() {
                return new DerivativeStructure_v0(compiler.getFreeParameters(), compiler.getOrder(), 1.0);
            }

            /** {@inheritDoc} */
            public Class<? extends FieldElement<DerivativeStructure_v0>> getRuntimeClass() {
                return DerivativeStructure_v0.class;
            }
     ...
     */
    public DerivativeStructure_v0 pow(final double p) {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     */
    public DerivativeStructure_v0 pow(final int n) {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public DerivativeStructure_v0 pow(final DerivativeStructure_v0 e)
        throws DimensionMismatchException {
     ...
     */
    public DerivativeStructure_v0 exp() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     */
    public DerivativeStructure_v0 log() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return cos(this)
     */
    public DerivativeStructure_v0 cos() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return sin(this)
     */
    public DerivativeStructure_v0 sin() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return tan(this)
     */
    public DerivativeStructure_v0 tan() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return acos(this)
     */
    public DerivativeStructure_v0 acos() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return asin(this)
     */
    public DerivativeStructure_v0 asin() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @return tan(this)
     */
    public DerivativeStructure_v0 atan() {
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(compiler);
     ...
     * @exception DimensionMismatchException if number of free parameters or orders are inconsistent
     */
    public static DerivativeStructure_v0 atan2(final DerivativeStructure_v0 y, final DerivativeStructure_v0 x)
        throws DimensionMismatchException {
        y.compiler.checkCompatibility(x.compiler);
        final DerivativeStructure_v0 result = new DerivativeStructure_v0(y.compiler);
    ...
    private static class DataTransferObject implements Serializable {
        ...
        /** Replace the deserialized data transfer object with a {@link DerivativeStructure_v0}.
         * @return replacement {@link DerivativeStructure_v0}
         */
        private Object readResolve() {
            final DerivativeStructure_v0 ds = new DerivativeStructure_v0(variables, order);
