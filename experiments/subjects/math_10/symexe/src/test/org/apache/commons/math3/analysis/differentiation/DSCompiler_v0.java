/*
 * revision: a87ba1f7c8b0b4cb5dd4d26083c578f3ef6bf861
 ...
 * @since 3.1
 */
public class DSCompiler_v0 {

    /** Array of all compilers created so far. */
    private static AtomicReference<DSCompiler_v0[][]> compilers =
            new AtomicReference<DSCompiler_v0[][]>(null);
     ...
     */
    public static DSCompiler_v0 getCompiler(int parameters, int order) {

        // get the cached compilers
        final DSCompiler_v0[][] cache = compilers.get();
        ...
        final DSCompiler_v0[][] newCache = new DSCompiler_v0[maxParameters + 1][maxOrder + 1];
        ...
        for (int diag = 0; diag <= maxParameters + maxOrder; ++diag) {
            for (int o = FastMath.max(0, diag - maxParameters); o <= FastMath.min(maxOrder, diag); ++o) {
                ...
                if (newCache[p][o] == null) {
                    final DSCompiler_v0 valueCompiler      = (p == 0) ? null : newCache[p - 1][o];
                    final DSCompiler_v0 derivativeCompiler = (o == 0) ? null : newCache[p][o - 1];
                    newCache[p][o] = new DSCompiler_v0(p, o, valueCompiler, derivativeCompiler);
                }
            }
        }
     ...
     */
    private DSCompiler_v0(final int parameters, final int order,
                       final DSCompiler_v0 valueCompiler, final DSCompiler_v0 derivativeCompiler) {
    ...
    private static int[][] compileSizes(final int parameters, final int order,
                                        final DSCompiler_v0 valueCompiler,
                                        final DSCompiler_v0 derivativeCompiler) {
     ...
     */
    public void checkCompatibility(final DSCompiler_v0 compiler)
