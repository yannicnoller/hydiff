 ...
 * function:
 * <ul>
 *  <li>{@link test.org.apache.commons.math3.optimization.univariate.UnivariateOptimizer
 *      UnivariateOptimizer} for {@link test.org.apache.commons.math3.analysis.UnivariateFunction
 *      univariate real functions}</li>
 *  <li>{@link test.org.apache.commons.math3.optimization.MultivariateOptimizer
 *      MultivariateOptimizer} for {@link test.org.apache.commons.math3.analysis.MultivariateFunction
 *      multivariate real functions}</li>
 *  <li>{@link test.org.apache.commons.math3.optimization.DifferentiableMultivariateOptimizer
 *      DifferentiableMultivariateOptimizer} for {@link
 *      test.org.apache.commons.math3.analysis.DifferentiableMultivariateFunction
 *      differentiable multivariate real functions}</li>
 *  <li>{@link test.org.apache.commons.math3.optimization.DifferentiableMultivariateVectorOptimizer
 *      DifferentiableMultivariateVectorOptimizer} for {@link
 *      test.org.apache.commons.math3.analysis.DifferentiableMultivariateVectorFunction
 ...
 * transform a {@link test.org.apache.commons.math3.analysis.MultivariateVectorFunction
 * non-differentiable multivariate vectorial function} by converting it to a {@link
 * test.org.apache.commons.math3.analysis.MultivariateFunction non-differentiable multivariate
 * real function} thanks to the {@link
 * test.org.apache.commons.math3.optimization.LeastSquaresConverter LeastSquaresConverter} helper class.
 * The transformed function can be optimized using any implementation of the {@link
 * test.org.apache.commons.math3.optimization.MultivariateOptimizer MultivariateOptimizer} interface.
 * </p>
 *
 * <p>
 ...
 *
 */
package test.org.apache.commons.math3.optimization;
