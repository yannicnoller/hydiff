...
import test.org.apache.commons.math3.geometry.partitioning.Side;
...
public class SubPlane extends AbstractSubHyperplane<Euclidean3D, Euclidean2D> {
    ...
    public Side side(Hyperplane<Euclidean3D> hyperplane) {
        ...
        final test.org.apache.commons.math3.geometry.euclidean.twod.Line line2D =
            new test.org.apache.commons.math3.geometry.euclidean.twod.Line(p, q);
    ...
    public SplitSubHyperplane<Euclidean3D> split(Hyperplane<Euclidean3D> hyperplane) {
        ...
        final SubHyperplane<Euclidean2D> l2DMinus =
            new test.org.apache.commons.math3.geometry.euclidean.twod.Line(p, q).wholeHyperplane();
        final SubHyperplane<Euclidean2D> l2DPlus =
            new test.org.apache.commons.math3.geometry.euclidean.twod.Line(q, p).wholeHyperplane();
