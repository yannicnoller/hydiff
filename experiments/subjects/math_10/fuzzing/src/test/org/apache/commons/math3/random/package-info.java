 ...
 *      <ul>
 *        <li>{@link test.org.apache.commons.math3.random.JDKRandomGenerator JDKRandomGenerator}
 ...
 *            <ul>
 *              <li>{@link test.org.apache.commons.math3.random.MersenneTwister MersenneTwister}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well512a Well512a}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well1024a Well1024a}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well19937a Well19937a}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well19937c Well19937c}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well44497a Well44497a}</li>
 *              <li>{@link test.org.apache.commons.math3.random.Well44497b Well44497b}</li>
 *            </ul>
 *          </li>
 *        </ul>
 *      </p>
 ...
 *          <tr><td>{@link test.org.apache.commons.math3.random.MersenneTwister MersenneTwister}</td><td>1</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.JDKRandomGenerator JDKRandomGenerator}</td><td>between 0.96 and 1.16</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well512a Well512a}</td><td>between 0.85 and 0.88</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well1024a Well1024a}</td><td>between 0.63 and 0.73</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well19937a Well19937a}</td><td>between 0.70 and 0.71</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well19937c Well19937c}</td><td>between 0.57 and 0.71</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well44497a Well44497a}</td><td>between 0.69 and 0.71</td></tr>
 *          <tr><td>{@link test.org.apache.commons.math3.random.Well44497b Well44497b}</td><td>between 0.65 and 0.71</td></tr>
 *        </table>
 *      </p>
 *
 *      <p>
 *      So for most simulation problems, the better generators like {@link
 *      test.org.apache.commons.math3.random.Well19937c Well19937c} and {@link
 *      test.org.apache.commons.math3.random.Well44497b Well44497b} are probably very good choices.
 *      </p>
 *
 *      <p>
 ...
 *
 */
package test.org.apache.commons.math3.random;
