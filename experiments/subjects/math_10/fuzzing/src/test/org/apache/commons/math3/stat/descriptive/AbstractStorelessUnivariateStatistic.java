...
public abstract class AbstractStorelessUnivariateStatistic
     ...
     * @see test.org.apache.commons.math3.stat.descriptive.UnivariateStatistic#evaluate(double[])
     */
    @Override
     ...
     * @see test.org.apache.commons.math3.stat.descriptive.UnivariateStatistic#evaluate(double[], int, int)
     */
    @Override
     ...
     * @see test.org.apache.commons.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[])
     */
     ...
     * @throws IllegalArgumentException if values is null
     * @see test.org.apache.commons.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[], int, int)
     */
