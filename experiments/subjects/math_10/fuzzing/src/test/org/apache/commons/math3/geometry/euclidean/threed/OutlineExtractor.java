...
import test.org.apache.commons.math3.geometry.euclidean.twod.PolygonsSet;
            ...
            if (FastMath.abs(scal) > 1.0e-3) {
                ...
                for (Vector2D[] loop : vertices) {
                    ...
                    while (current < loop.length) {
                        ...
                        final test.org.apache.commons.math3.geometry.euclidean.twod.Line line =
                            new test.org.apache.commons.math3.geometry.euclidean.twod.Line(pPoint, cPoint);
                        ...
                        if (closed || (previous != 1)) {
                            ...
                            final test.org.apache.commons.math3.geometry.euclidean.twod.Line l =
                                new test.org.apache.commons.math3.geometry.euclidean.twod.Line(pPoint, angle);
                        ...
                        if (closed || (current != (loop.length - 1))) {
                            ...
                            final double angle = line.getAngle() + 0.5 * FastMath.PI;
                            final test.org.apache.commons.math3.geometry.euclidean.twod.Line l =
                                new test.org.apache.commons.math3.geometry.euclidean.twod.Line(cPoint, angle);
