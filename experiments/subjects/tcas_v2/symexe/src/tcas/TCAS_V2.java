...
public class TCAS_V2 {
	...
	private int Inhibit_Biased_Climb (){
	    int tmp = change(NOZCROSS, MINSEP);
	    return (Climb_Inhibit ? Up_Separation + tmp : Up_Separation); // change NOZCROSS to MINSEP
	}
