...
public class HelpFormatter {
    ...
    // -------------------------------------------------------------- Attributes
    // changed: added getter/setter for attributes, which are now private
                           ...
                           Options options)
    {
        ...
        for (Iterator i = options.getOptions().iterator(); i.hasNext();)
        {
            ...
            if (group != null) // changed: condition
            {
            ...
            if (i.hasNext()) // changed: condition
            {
                buff.append(" ");
            }
        }
    ...
    {
        if (!group.isRequired()) // changed: condition
        {
            buff.append("[");
        }
        ...
        for (Iterator i = group.getOptions().iterator(); i.hasNext();)
        {
            ...
            appendOption(buff, (Option) i.next(), true); // changed: use appendOption instead of just dumping the string value
                                     ...
                                     final boolean required)
    {
        ...
        if (option.getOpt() != null) // changed: condition
        {
        ...
        {
            buff.append(" <").append(option.getArgName()).append(">"); // changed: added "<" ">"
        }
    ...
    private static class OptionComparator
        ...
        public int compare(Object o1, Object o2)
        {
            ...
            return opt1.getKey().compareToIgnoreCase(opt2.getKey()); // changed
        }
    }
}
