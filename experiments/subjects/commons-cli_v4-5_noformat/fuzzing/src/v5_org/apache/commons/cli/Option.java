 ...
 *
 * @see v5_org.apache.commons.cli.Options
 * @see v5_org.apache.commons.cli.CommandLine
 *
...
public class Option {
   ...
   /** 
     ...
     */
    public void setDescription(String description) // changed: added new method
    {
        this.description = description;
    }
     ...
     * @return whether this Option has specified a value separator.
     */
    public boolean hasValueSeparator() // changed: added method
    {
    ...
    void addValue(String value) 
    {
        ...
        {
        case UNINITIALIZED:
            throw new RuntimeException("NO_ARGS_ALLOWED"); // changed: exception introduced

        default:
            processValue(value); // changed: processing changed
        }
    }
    ...
    {
        return hasNoValues() ? null : (String) this.values.get(0); // changed condition
    }
