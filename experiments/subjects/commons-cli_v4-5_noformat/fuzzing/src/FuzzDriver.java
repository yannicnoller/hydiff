...
public class FuzzDriver {
    ...
    public static void main(String[] args) {
        ...
        Object res1 = null;
        try {
            v4_org.apache.commons.cli.Options _options4 = new v4_org.apache.commons.cli.Options();
            for (int i = 0; i < options_list.size(); i++) {
                _options4.addOption(options_list.get(i), "enable_" + options_list.get(i), options_args[i],
            ...
            v4_org.apache.commons.cli.CommandLine cl4gnu = _parser4gnu.parse(_options4, args_test, stopAtNonOption);
            String res1_gnu = cl4gnu.getOptionValue(opt);

            v4_org.apache.commons.cli.CommandLineParser _parser4posix = new v4_org.apache.commons.cli.PosixParser();
            v4_org.apache.commons.cli.CommandLine cl4posix = _parser4posix.parse(_options4, args_test, stopAtNonOption);
            String res1_posix = cl4posix.getOptionValue(opt);
        ...
        try {
            ...
            String res2_gnu = cl5gnu.getOptionValue(opt);
            ...
            String res2_posix = cl5posix.getOptionValue(opt);
