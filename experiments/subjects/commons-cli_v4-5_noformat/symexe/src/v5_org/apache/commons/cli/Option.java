...
public class Option {
   ...
   /** 
    ...
    private void processValue(String value)
    {
        ...
        if (hasValueSeparator())
        {
            ...
            while (index != -1)
            {
                ...
                if (change(numberOfArgs != UNLIMITED_VALUES && values.size() == (numberOfArgs - 1), values.size() == (numberOfArgs - 1)))
                {
                    if(change(false, true)) {
                        break;
                    }
    ...
    {
        boolean tmp = change(this.values.size()==0, hasNoValues());
        return tmp ? null : (String) this.values.get(0);
    }
    ...
    {
        boolean tmp = change(this.values.size()==0, hasNoValues());
        return tmp ? null : (String) this.values.get(index);
    }
