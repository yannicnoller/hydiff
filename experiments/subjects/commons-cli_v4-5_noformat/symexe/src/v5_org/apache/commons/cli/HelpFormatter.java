...
public class HelpFormatter {
                           ...
                           Options options)
    {
        ...
        for (Iterator i = options.getOptions().iterator(); i.hasNext();)
        {
            ...
            if (change(group != null && !processedGroups.contains(group), group != null))
            {
            ...
            if (change((group == null || processedGroups.contains(group)), i.hasNext()))
            {
                buff.append(" ");
            }
        }
    ...
    {
        if (change(true, !group.isRequired()))
        {
        ...
        for (Iterator i = group.getOptions().iterator(); i.hasNext();)
        {
            ...
            // appendOption(buff, (Option) i.next(), true); // changed: difficult to annotate
                                     ...
                                     final boolean required)
    {
        ...
        if (change(!" ".equals( option.getOpt() ), option.getOpt() != null))
        {
        ...
        {
            // buff.append(" <").append(option.getArgName()).append(">"); // changed
            if (change(false, true)) {
                buff.append(" <");
            }
    ...
    protected int findWrapPos(String text, int width, int startPos)
    {
        ...
        {
            return change(pos, pos+1); // change
        }
    ...
    private static class OptionComparator
        ...
        {
            String str1 = stripPrefixOLD(o1.toString());
            String str2 = stripPrefixOLD(o2.toString());
            int res1 = str1.compareTo(str2);
            
            Option opt1 = (Option)o1;
            Option opt2 = (Option)o2;
            int res2 = opt1.getKey().compareToIgnoreCase(opt2.getKey());
            
            return change(res1, res2);
        }
        
        private String stripPrefixOLD(String strOption)
        {
