 ...
 * @version $Id$
 */
public class Complex0 implements FieldElement<Complex0>, Serializable  {
    /** The square root of -1. A number representing "0.0 + 1.0i" */
    public static final Complex0 I = new Complex0(0.0, 1.0);
    // CHECKSTYLE: stop ConstantName
    /** A complex number representing "NaN + NaNi" */
    public static final Complex0 NaN = new Complex0(Double.NaN, Double.NaN);
    // CHECKSTYLE: resume ConstantName
    /** A complex number representing "+INF + INFi" */
    public static final Complex0 INF = new Complex0(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
    /** A complex number representing "1.0 + 0.0i" */
    public static final Complex0 ONE = new Complex0(1.0, 0.0);
    /** A complex number representing "0.0 + 0.0i" */
    public static final Complex0 ZERO = new Complex0(0.0, 0.0);
     ...
     */
    public Complex0(double real, double imaginary) {
        this.real = real;
     ...
     */
    public Complex0 add(Complex0 addend) throws NullArgumentException {
     ...
     * @see #add(Complex0)
     */
    public Complex0 add(double addend) {
     ...
     */
    public Complex0 divide(Complex0 divisor)
     ...
     * @see #divide(Complex0)
     */
    public Complex0 divide(double divisor) {
     ...
     */
    public Complex0 multiply(Complex0 factor)
        throws NullArgumentException {
     ...
     * @param  factor value to be multiplied by this {@code Complex}.
     * @return {@code this * factor}.
     * @see #multiply(Complex0)
     */
    public Complex0 multiply(double factor) {
     ...
     */
    public Complex0 subtract(Complex0 subtrahend)
        throws NullArgumentException {
     ...
     * @param  subtrahend value to be subtracted from this {@code Complex}.
     * @return {@code this - subtrahend}.
     * @see #subtract(Complex0)
     */
    public Complex0 subtract(double subtrahend) {
     ...
     *  </code>
     * </pre>
     * Returns {@link Complex0#NaN} if either real or imaginary part of the
     * input argument is {@code NaN} or infinite.
     *
     * @return the inverse cosine of this complex number.
     * @since 1.2
     */
    public Complex0 acos() {
        if (isNaN) {
            return NaN;
        }
     ...
     * {@code |a + bi|} is the modulus, {@link Complex0#abs},  and
     ...
     * @since 1.2
     */
    public Complex0 pow(Complex0 x)
        throws NullArgumentException {
     ...
     * <li>{@code |a + bi| = }{@link Complex0#abs}(a + bi)</li>
     ...
     * @since 2.0
     */
    public List<Complex0> nthRoot(int n) {
        ...
        final List<Complex0> result = new ArrayList<Complex0>();
     ...
     */
    protected Complex0 createComplex(double realPart,
                                    double imaginaryPart) {
        return new Complex0(realPart, imaginaryPart);
    }
     ...
     */
    public static Complex0 valueOf(double realPart,
                                  double imaginaryPart) {
    ...
    /** {@inheritDoc} */
    public ComplexField0 getField() {
        return ComplexField0.getInstance();
    }
