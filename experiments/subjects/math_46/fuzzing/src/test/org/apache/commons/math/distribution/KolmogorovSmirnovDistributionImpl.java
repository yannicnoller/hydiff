...
import test.org.apache.commons.math.fraction.BigFractionField;
import test.org.apache.commons.math.fraction.FractionConversionException;
...
public class KolmogorovSmirnovDistributionImpl implements KolmogorovSmirnovDistribution, Serializable {
     ...
     * {@link test.org.apache.commons.math.fraction.BigFraction}.
     *
     * @param d statistic
     * @return the two-sided probability of {@code P(D}<sub>n</sub> {@code < d)}
     * @throws MathArithmeticException
     *             if algorithm fails to convert {@code h} to a
     *             {@link test.org.apache.commons.math.fraction.BigFraction} in
