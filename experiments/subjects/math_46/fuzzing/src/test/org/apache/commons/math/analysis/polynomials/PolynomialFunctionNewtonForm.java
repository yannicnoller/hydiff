 ...
 */
package test.org.apache.commons.math.analysis.polynomials;
...
public class PolynomialFunctionNewtonForm implements UnivariateRealFunction {
     ...
     * @throws DimensionMismatchException if the size difference between
     * {@code a} and {@code c} is not equal to 1.
     * @see test.org.apache.commons.math.analysis.interpolation.DividedDifferenceInterpolator#computeDividedDifference(double[],
     * double[])
     */
