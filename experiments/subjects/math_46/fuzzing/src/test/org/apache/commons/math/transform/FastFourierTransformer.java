 ...
 */
package test.org.apache.commons.math.transform;
...
public class FastFourierTransformer implements Serializable {
     ...
     */
    public Complex1[] transform(double f[])
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] transform(UnivariateRealFunction f,
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] transform(Complex1 f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] transform2(double f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] transform2(UnivariateRealFunction f,
                                double min, double max, int n)
        throws MathUserException, IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] transform2(Complex1 f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform(double f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform(UnivariateRealFunction f,
                                      double min, double max, int n)
        throws MathUserException, IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform(Complex1 f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform2(double f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform2(UnivariateRealFunction f,
                                       double min, double max, int n)
        throws MathUserException, IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    public Complex1[] inversetransform2(Complex1 f[])
        throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    protected Complex1[] fft(double f[], boolean isInverse)
        throws IllegalArgumentException {

        verifyDataSet(f);
        Complex1 F[] = new Complex1[f.length];
        if (f.length == 1) {
            F[0] = new Complex1(f[0], 0.0);
            return F;
        }
        ...
        int N = f.length >> 1;
        Complex1 c[] = new Complex1[N];
        for (int i = 0; i < N; i++) {
            c[i] = new Complex1(f[2*i], f[2*i+1]);
        }
        ...
        F[0] = new Complex1(2 * (z[0].getReal() + z[0].getImaginary()), 0.0);
        F[N] = new Complex1(2 * (z[0].getReal() - z[0].getImaginary()), 0.0);
        for (int i = 1; i < N; i++) {
            Complex1 A = z[N-i].conjugate();
            Complex1 B = z[i].add(A);
            Complex1 C = z[i].subtract(A);
            //Complex D = roots.getOmega(i).multiply(Complex.I);
            Complex1 D = new Complex1(-roots.getOmegaImaginary(i),
     ...
     * @throws IllegalArgumentException if any parameters are invalid
     */
    protected Complex1[] fft(Complex1 data[])
        throws IllegalArgumentException {

        final int n = data.length;
        final Complex1 f[] = new Complex1[n];
        ...
        for (int i = 0; i < n; i += 4) {
            final Complex1 a = f[i].add(f[i+1]);
            final Complex1 b = f[i+2].add(f[i+3]);
            final Complex1 c = f[i].subtract(f[i+1]);
            final Complex1 d = f[i+2].subtract(f[i+3]);
            final Complex1 e1 = c.add(d.multiply(Complex1.I));
            final Complex1 e2 = c.subtract(d.multiply(Complex1.I));
            f[i] = a.add(b);
            f[i+2] = a.subtract(b);
     ...
     * @return a reference to the scaled array
     */
    public static Complex1[] scaleArray(Complex1 f[], double d) {
        for (int i = 0; i < f.length; i++) {
            f[i] = new Complex1(d * f[i].getReal(), d * f[i].getImaginary());
        }
        return f;
    }
     ...
     * Use {@link #inversetransform2(Complex1[])} and
     * {@link #transform2(Complex1[])} in a row-column implementation
    ...
    private void mdfft(MultiDimensionalComplexMatrix mdcm, boolean forward,
        ...
        if (subVector.length == dimensionSize.length) {
            Complex1[] temp = new Complex1[dimensionSize[d]];
    ...
    private static class MultiDimensionalComplexMatrix
         ...
         */
        public Complex1 get(int... vector)
            throws IllegalArgumentException {
            if (vector == null) {
         ...
         * @exception IllegalArgumentException if dimensions do not match
         */
        public Complex1 set(Complex1 magnitude, int... vector)
            throws IllegalArgumentException {
            if (vector == null) {
                if (dimensionSize.length > 0) {
                    throw MathRuntimeException.createIllegalArgumentException(
            ...
            Complex1 lastValue = (Complex1) lastDimension[vector[dimensionSize.length - 1]];
