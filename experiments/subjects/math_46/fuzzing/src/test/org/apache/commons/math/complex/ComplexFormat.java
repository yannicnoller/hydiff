...
public class ComplexFormat {
     ...
     */
    public String format(Complex1 c) {
    ...
    public String format(Double c) {
        return format(new Complex1(c, 0), new StringBuffer(), new FieldPosition(0)).toString();
    }

    /**
     * Formats a {@link Complex1} object to produce a string.
     *
     ...
     */
    public StringBuffer format(Complex1 complex, StringBuffer toAppendTo,
                               FieldPosition pos) {
        pos.setBeginIndex(0);
        pos.setEndIndex(0);
     ...
     * {@link Complex1} object or a {@link Number} object.  Any other type of
    ...
    public StringBuffer format(Object obj, StringBuffer toAppendTo,
        ...
        if (obj instanceof Complex1) {
            ret = format( (Complex1)obj, toAppendTo, pos);
        } else if (obj instanceof Number) {
            ret = format(new Complex1(((Number)obj).doubleValue(), 0.0),
                         toAppendTo, pos);
        } else {
    ...
    /**
     * Parses a string to produce a {@link Complex1} object.
     *
     * @param source the string to parse.
     * @return the parsed {@link Complex1} object.
     * @throws MathParseException if the beginning of the specified string
     * cannot be parsed.
     */
    public Complex1 parse(String source) {
        ParsePosition parsePosition = new ParsePosition(0);
        Complex1 result = parse(source, parsePosition);
     ...
     * @return the parsed {@link Complex1} object.
     */
    public Complex1 parse(String source, ParsePosition pos) {
        ...
        case 0 :
            ...
            return new Complex1(re.doubleValue(), 0.0);
        case '-' :
            sign = -1;
            break;
        case '+' :
        ...
        return new Complex1(re.doubleValue(), im.doubleValue() * sign);
