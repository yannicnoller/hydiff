 ...
 */
package test.org.apache.commons.math.analysis.interpolation;

import java.io.Serializable;
import java.util.Arrays;

import test.org.apache.commons.math.analysis.polynomials.PolynomialSplineFunction;
...
public class LoessInterpolator
     ...
     * with a
     * {@link test.org.apache.commons.math.analysis.interpolation.SplineInterpolator}
     * on the resulting fit.
     *
     * @param xval the arguments for the interpolation points
     * @param yval the values for the interpolation points
     * @return A cubic spline built upon a loess fit to the data at the original abscissae
     * @throws test.org.apache.commons.math.exception.NonMonotonousSequenceException
     * if {@code xval} not sorted in strictly increasing order.
     * @throws DimensionMismatchException if {@code xval} and {@code yval} have
     * different sizes.
     * @throws NoDataException if {@code xval} or {@code yval} has zero size.
     * @throws test.org.apache.commons.math.exception.NotFiniteNumberException if
     ...
     * @throws test.org.apache.commons.math.exception.NotFiniteNumberException
