...
import test.org.apache.commons.math.optimization.BaseOptimizer;
...
public interface BaseUnivariateRealOptimizer<FUNC extends UnivariateRealFunction>
     ...
     * @throws test.org.apache.commons.math.exception.TooManyEvaluationsException
     * if the maximum evaluation count is exceeded.
     * @throws test.org.apache.commons.math.exception.ConvergenceException if the
     * optimizer detects a convergence problem.
     * @throws IllegalArgumentException if {@code min > max} or the endpoints
     * do not satisfy the requirements specified by the optimizer.
     * @throws test.org.apache.commons.math.exception.NullArgumentException if any
