 ...
 * {@link test.org.apache.commons.math.complex.Complex1} utilities functions.
 *
 * @version $Id$
 */
public class ComplexUtils {
     ...
     * <code>theta</code> is infinite, {@link Complex1#NaN} is returned.</p>
     * <p>
     ...
     * @since 1.1
     */
    public static Complex1 polar2Complex(double r, double theta) {
        if (r < 0) {
            throw MathRuntimeException.createIllegalArgumentException(
                  LocalizedFormats.NEGATIVE_COMPLEX_MODULE, r);
        }
        return new Complex1(r * FastMath.cos(theta), r * FastMath.sin(theta));
    }
