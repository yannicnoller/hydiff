...
public class TCAS_V8 {
	...
	void initialize(){
	    ...
	    Positive_RA_Alt_Thresh[3] = change(740, 700); /* constant mutation change 740 to 700*/
	}
	...
	public int startTcas(int cvs, boolean hc, boolean ttrv, int ota, int otar,
		...
		Other_Capability = oc;
		Climb_Inhibit = ci;
	    /* hack for spf because pc will be null when hitting the change */
        if (ci) {
            int i = 0;
        }
    	initialize();
