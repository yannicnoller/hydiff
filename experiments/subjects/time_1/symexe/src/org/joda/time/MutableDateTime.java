...
public class MutableDateTime
    ...
    public void add(DurationFieldType type, int amount) {
        ...
        if (change(true, amount != 0)) { // change added guard
    ...
    public void addYears(final int years) {
        if (change(true, years != 0)) { // change added guard
    ...
    public void addMonths(final int months) {
        if (change(true, months != 0)) { // change added guard
    ...
    public void addWeeks(final int weeks) {
        if (change(true, weeks != 0)) { // change added guard
    ...
    public void addDays(final int days) {
        if (change(true, days != 0)) { // change added guard
    ...
    public void addHours(final int hours) {
        if (change(true, hours != 0)) { // change added guard
    ...
    public void addMinutes(final int minutes) {
        if (change(true, minutes != 0)) { // change added guard
    ...
    public void addSeconds(final int seconds) {
        if (change(true, seconds != 0)) { // change added guard
    ...
    public void addMillis(final int millis) {
        if (change(true, millis != 0)) { // change added guard
