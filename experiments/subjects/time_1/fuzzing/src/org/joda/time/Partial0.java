...
public final class Partial0
     ...
     */
    public Partial0(Chronology chrono) {
        super();
     ...
     */
    public Partial0(DateTimeFieldType type, int value) {
     ...
     * @throws IllegalArgumentException if the type or value is invalid
     */
    public Partial0(DateTimeFieldType type, int value, Chronology chronology) {
        super();
     ...
     */
    public Partial0(DateTimeFieldType[] types, int[] values) {
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    public Partial0(DateTimeFieldType[] types, int[] values, Chronology chronology) {
        super();
        chronology = DateTimeUtils.getChronology(chronology).withUTC();
        iChronology = chronology;
        if (types == null) {
     ...
     */
    public Partial0(ReadablePartial partial) {
        super();
        if (partial == null) {
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    Partial0(Partial0 partial, int[] values) {
        super();
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    Partial0(Chronology chronology, DateTimeFieldType[] types, int[] values) {
        super();
        iChronology = chronology;
        iTypes = types;
        iValues = values;
     ...
     */
    public Partial0 withChronologyRetainFields(Chronology newChronology) {
        newChronology = DateTimeUtils.getChronology(newChronology);
        newChronology = newChronology.withUTC();
        if (newChronology == getChronology()) {
            return this;
        } else {
            Partial0 newPartial = new Partial0(newChronology, iTypes, iValues);
     ...
     */
    public Partial0 with(DateTimeFieldType fieldType, int value) {
        if (fieldType == null) {
            throw new IllegalArgumentException("The field type must not be null");
        }
        ...
        if (index == -1) {
            ...
            Partial0 newPartial = new Partial0(newTypes, newValues, iChronology);
        ...
        return new Partial0(this, newValues);
    }
     ...
     */
    public Partial0 without(DateTimeFieldType fieldType) {
        int index = indexOf(fieldType);
        if (index != -1) {
            ...
            Partial0 newPartial = new Partial0(iChronology, newTypes, newValues);
            iChronology.validate(newPartial, newValues);
            return newPartial;
        }
        return this;
     ...
     * @throws IllegalArgumentException if the value is null or invalid
     */
    public Partial0 withField(DateTimeFieldType fieldType, int value) {
     ...
     */
    public Partial0 withFieldAdded(DurationFieldType fieldType, int amount) {
        int index = indexOfSupported(fieldType);
        if (amount == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity
     */
    public Partial0 withFieldAddWrapped(DurationFieldType fieldType, int amount) {
        int index = indexOfSupported(fieldType);
        if (amount == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity
     */
    public Partial0 withPeriodAdded(ReadablePeriod period, int scalar) {
     ...
     */
    public Partial0 plus(ReadablePeriod period) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public Partial0 minus(ReadablePeriod period) {
        return withPeriodAdded(period, -1);
    }
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
        ...
        /** The partial */
        private final Partial0 iPartial;
        /** The field index */
         ...
         */
        Property(Partial0 partial, int fieldIndex) {
            super();
            iPartial = partial;
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial0 addWrapFieldToCopy(int valueToAdd) {
            int[] newValues = iPartial.getValues();
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial0 setCopy(int value) {
            int[] newValues = iPartial.getValues();
         ...
         */
        public Partial0 setCopy(String text, Locale locale) {
            int[] newValues = iPartial.getValues();
         ...
         * @throws IllegalArgumentException if the text value isn't valid
         */
        public Partial0 setCopy(String text) {
         ...
         * @since 1.2
         */
        public Partial0 withMaximumValue() {
         ...
         * @since 1.2
         */
        public Partial0 withMinimumValue() {
