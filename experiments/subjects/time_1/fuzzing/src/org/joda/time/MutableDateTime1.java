...
public class MutableDateTime1
     ...
     * @since 2.0
     */
    public static MutableDateTime1 now() {
        return new MutableDateTime1();
    }
     ...
     * @since 2.0
     */
    public static MutableDateTime1 now(DateTimeZone zone) {
        if (zone == null) {
            throw new NullPointerException("Zone must not be null");
        }
        return new MutableDateTime1(zone);
    }
     ...
     * @since 2.0
     */
    public static MutableDateTime1 now(Chronology chronology) {
        if (chronology == null) {
            throw new NullPointerException("Chronology must not be null");
        }
        return new MutableDateTime1(chronology);
    }
     ...
     */
    @FromString
    public static MutableDateTime1 parse(String str) {
     ...
     * @since 2.0
     */
    public static MutableDateTime1 parse(String str, DateTimeFormatter formatter) {
     ...
     */
    public MutableDateTime1(DateTimeZone zone) {
        super(zone);
    }
     ...
     * @see #now(Chronology)
     */
    public MutableDateTime1(Chronology chronology) {
        super(chronology);
    }
     ...
     */
    public MutableDateTime1(long instant) {
        super(instant);
    }
     ...
     * @param zone  the time zone, null means default zone
     */
    public MutableDateTime1(long instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @param chronology  the chronology, null means ISOChronology in default zone
     */
    public MutableDateTime1(long instant, Chronology chronology) {
     ...
     */
    public MutableDateTime1(Object instant) {
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public MutableDateTime1(Object instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public MutableDateTime1(Object instant, Chronology chronology) {
    ...
    public void setRounding(DateTimeField field) {
        setRounding(field, MutableDateTime1.ROUND_FLOOR);
    }
    ...
    public void add(DurationFieldType type, int amount) {
        ...
        if (amount != 0) { // change added guard
    ...
    public void addMonths(final int months) {
        if (months != 0) { // change added guard
    ...
    public void addMinutes(final int minutes) {
        if (minutes != 0) { // change added guard
    ...
    public void addSeconds(final int seconds) {
        if (seconds != 0) { // change added guard
    ...
    public void addMillis(final int millis) {
        if (millis != 0) { // change added guard
     ...
     */
    public MutableDateTime1 copy() {
        return (MutableDateTime1) clone();
    }
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        private MutableDateTime1 iInstant;
         ...
         */
        Property(MutableDateTime1 instant, DateTimeField field) {
            super();
            iInstant = instant;
            iField = field;
        }
        ...
        private void readObject(ObjectInputStream oos) throws IOException, ClassNotFoundException {
            iInstant = (MutableDateTime1) oos.readObject();
         ...
         */
        public MutableDateTime1 getMutableDateTime() {
            return iInstant;
        }
         ...
         */
        public MutableDateTime1 add(int value) {
         ...
         */
        public MutableDateTime1 add(long value) {
            iInstant.setMillis(getField().add(iInstant.getMillis(), value));
            return iInstant;
        }
         ...
         */
        public MutableDateTime1 addWrapField(int value) {
         ...
         */
        public MutableDateTime1 set(int value) {
         ...
         */
        public MutableDateTime1 set(String text, Locale locale) {
         ...
         */
        public MutableDateTime1 set(String text) {
            set(text, null);
            return iInstant;
        }
         ...
         */
        public MutableDateTime1 roundFloor() {
         ...
         */
        public MutableDateTime1 roundCeiling() {
         ...
         */
        public MutableDateTime1 roundHalfFloor() {
         ...
         */
        public MutableDateTime1 roundHalfCeiling() {
         ...
         */
        public MutableDateTime1 roundHalfEven() {
