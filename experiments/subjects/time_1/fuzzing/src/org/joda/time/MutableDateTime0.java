...
public class MutableDateTime0
     ...
     * @since 2.0
     */
    public static MutableDateTime0 now() {
        return new MutableDateTime0();
    }
     ...
     * @since 2.0
     */
    public static MutableDateTime0 now(DateTimeZone zone) {
        if (zone == null) {
            throw new NullPointerException("Zone must not be null");
        }
        return new MutableDateTime0(zone);
    }
     ...
     * @since 2.0
     */
    public static MutableDateTime0 now(Chronology chronology) {
        if (chronology == null) {
            throw new NullPointerException("Chronology must not be null");
        }
        return new MutableDateTime0(chronology);
    }
     ...
     */
    @FromString
    public static MutableDateTime0 parse(String str) {
     ...
     * @since 2.0
     */
    public static MutableDateTime0 parse(String str, DateTimeFormatter formatter) {
//        return formatter.parseDateTime(str).toMutableDateTime(); // TODO YN: later
        return null;
    }
     ...
     */
    public MutableDateTime0(DateTimeZone zone) {
        super(zone);
    }
     ...
     * @see #now(Chronology)
     */
    public MutableDateTime0(Chronology chronology) {
        super(chronology);
    }
     ...
     */
    public MutableDateTime0(long instant) {
        super(instant);
    }
     ...
     * @param zone  the time zone, null means default zone
     */
    public MutableDateTime0(long instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @param chronology  the chronology, null means ISOChronology in default zone
     */
    public MutableDateTime0(long instant, Chronology chronology) {
     ...
     */
    public MutableDateTime0(Object instant) {
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public MutableDateTime0(Object instant, DateTimeZone zone) {
        super(instant, zone);
    }
     ...
     * @throws IllegalArgumentException if the instant is invalid
     */
    public MutableDateTime0(Object instant, Chronology chronology) {
    ...
    public void setRounding(DateTimeField field) {
        setRounding(field, MutableDateTime0.ROUND_FLOOR);
    }
     ...
     */
    public MutableDateTime0 copy() {
        return (MutableDateTime0) clone();
    }
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        private MutableDateTime0 iInstant;
         ...
         */
        Property(MutableDateTime0 instant, DateTimeField field) {
            super();
            iInstant = instant;
            iField = field;
        }
        ...
        private void readObject(ObjectInputStream oos) throws IOException, ClassNotFoundException {
            iInstant = (MutableDateTime0) oos.readObject();
         ...
         */
        public MutableDateTime0 getMutableDateTime() {
            return iInstant;
        }
         ...
         */
        public MutableDateTime0 add(int value) {
         ...
         */
        public MutableDateTime0 add(long value) {
            iInstant.setMillis(getField().add(iInstant.getMillis(), value));
            return iInstant;
        }
         ...
         */
        public MutableDateTime0 addWrapField(int value) {
         ...
         */
        public MutableDateTime0 set(int value) {
         ...
         */
        public MutableDateTime0 set(String text, Locale locale) {
         ...
         */
        public MutableDateTime0 set(String text) {
            set(text, null);
            return iInstant;
        }
         ...
         */
        public MutableDateTime0 roundFloor() {
         ...
         */
        public MutableDateTime0 roundCeiling() {
         ...
         */
        public MutableDateTime0 roundHalfFloor() {
         ...
         */
        public MutableDateTime0 roundHalfCeiling() {
         ...
         */
        public MutableDateTime0 roundHalfEven() {
