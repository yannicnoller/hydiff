...
public final class Partial1
     ...
     */
    public Partial1(Chronology chrono) {
        super();
     ...
     */
    public Partial1(DateTimeFieldType type, int value) {
     ...
     * @throws IllegalArgumentException if the type or value is invalid
     */
    public Partial1(DateTimeFieldType type, int value, Chronology chronology) {
        super();
     ...
     */
    public Partial1(DateTimeFieldType[] types, int[] values) {
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    public Partial1(DateTimeFieldType[] types, int[] values, Chronology chronology) {
        super();
        chronology = DateTimeUtils.getChronology(chronology).withUTC();
        iChronology = chronology;
        if (types == null) {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            if (i > 0) {
                ...
                if (compare < 0) { // changed condition
                    ...
                    if (types[i - 1].getRangeDurationType() == null) {
                        if (loopType.getRangeDurationType() == null) {
                            throw new IllegalArgumentException("Types array must not contain duplicate: " +
                                            types[i - 1].getName() + " and " + loopType.getName()); // changed message
                        }
                    } else {
                        if (loopType.getRangeDurationType() == null) {
                            throw new IllegalArgumentException("Types array must be in order largest-smallest: " +
     ...
     */
    public Partial1(ReadablePartial partial) {
        super();
        if (partial == null) {
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    Partial1(Partial1 partial, int[] values) {
        super();
     ...
     * @throws IllegalArgumentException if the types or values are invalid
     */
    Partial1(Chronology chronology, DateTimeFieldType[] types, int[] values) {
        super();
        iChronology = chronology;
        iTypes = types;
        iValues = values;
     ...
     */
    public Partial1 withChronologyRetainFields(Chronology newChronology) {
        newChronology = DateTimeUtils.getChronology(newChronology);
        newChronology = newChronology.withUTC();
        if (newChronology == getChronology()) {
            return this;
        } else {
            Partial1 newPartial = new Partial1(newChronology, iTypes, iValues);
     ...
     */
    public Partial1 with(DateTimeFieldType fieldType, int value) {
        if (fieldType == null) {
            throw new IllegalArgumentException("The field type must not be null");
        }
        ...
        if (index == -1) {
                ...
                for (; i < iTypes.length; i++) {
                    ...
                    if (loopUnitField.isSupported()) {
                        ...
                        if (compare > 0) {
                            ...
                            if (fieldType.getRangeDurationType() == null) { // changed added guarded break
                                break;
                            }
            ...
            Partial1 newPartial = new Partial1(newTypes, newValues, iChronology);
        ...
        return new Partial1(this, newValues);
    }
     ...
     */
    public Partial1 without(DateTimeFieldType fieldType) {
        int index = indexOf(fieldType);
        if (index != -1) {
            ...
            Partial1 newPartial = new Partial1(iChronology, newTypes, newValues);
            iChronology.validate(newPartial, newValues);
            return newPartial;
        }
        return this;
     ...
     * @throws IllegalArgumentException if the value is null or invalid
     */
    public Partial1 withField(DateTimeFieldType fieldType, int value) {
     ...
     */
    public Partial1 withFieldAdded(DurationFieldType fieldType, int amount) {
        int index = indexOfSupported(fieldType);
        if (amount == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity
     */
    public Partial1 withFieldAddWrapped(DurationFieldType fieldType, int amount) {
        int index = indexOfSupported(fieldType);
        if (amount == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity
     */
    public Partial1 withPeriodAdded(ReadablePeriod period, int scalar) {
     ...
     */
    public Partial1 plus(ReadablePeriod period) {
     ...
     * @throws ArithmeticException if the new datetime exceeds the capacity of a long
     */
    public Partial1 minus(ReadablePeriod period) {
        return withPeriodAdded(period, -1);
    }
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
        ...
        /** The partial */
        private final Partial1 iPartial;
        /** The field index */
         ...
         */
        Property(Partial1 partial, int fieldIndex) {
            super();
            iPartial = partial;
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial1 addWrapFieldToCopy(int valueToAdd) {
            int[] newValues = iPartial.getValues();
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial1 setCopy(int value) {
            int[] newValues = iPartial.getValues();
         ...
         */
        public Partial1 setCopy(String text, Locale locale) {
            int[] newValues = iPartial.getValues();
         ...
         * @throws IllegalArgumentException if the text value isn't valid
         */
        public Partial1 setCopy(String text) {
         ...
         * @since 1.2
         */
        public Partial1 withMaximumValue() {
         ...
         * @since 1.2
         */
        public Partial1 withMinimumValue() {
