...
import org.joda.time.MutableDateTime1;
...
public abstract class AbstractInstant implements ReadableInstant {
     ...
     */
    public MutableDateTime1 toMutableDateTime() {
        return new MutableDateTime1(getMillis(), getZone());
    }
     ...
     */
    public MutableDateTime1 toMutableDateTimeISO() {
        return new MutableDateTime1(getMillis(), ISOChronology.getInstance(getZone()));
    }
     ...
     * @return a MutableDateTime using the same millis
     */
    public MutableDateTime1 toMutableDateTime(DateTimeZone zone) {
        Chronology chrono = DateTimeUtils.getChronology(getChronology());
        chrono = chrono.withZone(zone);
        return new MutableDateTime1(getMillis(), chrono);
    }
     ...
     * @return a MutableDateTime using the same millis
     */
    public MutableDateTime1 toMutableDateTime(Chronology chronology) {
        return new MutableDateTime1(getMillis(), chronology);
    }
