...
public class TCAS_V10 {
	...
	private boolean Own_Below_Threat(){
	    ...
	    return change((Own_Tracked_Alt < Other_Tracked_Alt), (Own_Tracked_Alt <= Other_Tracked_Alt)); // change1: < to <=
	}

	private boolean Own_Above_Threat(){
		/* NOTE JMW replaced LESS-THAN with LESS-THAN-EQUAL. */
	    return change((Other_Tracked_Alt < Own_Tracked_Alt), (Other_Tracked_Alt <= Own_Tracked_Alt)); // change2: < to <=
	}
