...
package test.org.apache.commons.math.ode.events;
...
public interface EventHandler  {
   ...
   * test.org.apache.commons.math.ode.FirstOrderDifferentialEquations#computeDerivatives}
   * method).</p>
   */
   ...
   * test.org.apache.commons.math.ode.FirstOrderDifferentialEquations
   ...
   *   test.org.apache.commons.math.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * test.org.apache.commons.math.ode.sampling.StepHandler StepHandler} method {@link
   * test.org.apache.commons.math.ode.sampling.StepHandler#handleStep(
   * test.org.apache.commons.math.ode.sampling.StepInterpolator, boolean)
   ...
   * test.org.apache.commons.math.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link test.org.apache.commons.math.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * test.org.apache.commons.math.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * test.org.apache.commons.math.ode.sampling.FixedStepHandler fixed step handlers}.</p>
