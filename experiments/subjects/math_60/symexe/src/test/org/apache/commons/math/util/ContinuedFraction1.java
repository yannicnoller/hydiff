...
public abstract class ContinuedFraction1 {
    ...
    /**
     * Access the n-th a coefficient of the continued fraction. Since a can be a function of the evaluation point, x,
    ...
    /**
     * Access the n-th b coefficient of the continued fraction. Since b can be a function of the evaluation point, x,
     * that is passed in as well.
     * 
     * @param n
     *            the coefficient index to retrieve.
     ...
     * <ul>
     * <li>Eric W. Weisstein. "Continued Fraction." From MathWorld--A Wolfram Web Resource.
     * <a target="_blank" href="http://mathworld.wolfram.com/ContinuedFraction.html">
     * http://mathworld.wolfram.com/ContinuedFraction.html</a></li>
     * </ul>
     * The recurrence relationship defined in those equations can result in very large intermediate results which can
     * result in numerical overflow. As a means to combat these overflow conditions, the intermediate results are scaled
     * whenever they threaten to become numerically unstable.
     * </p>
     *
     * @param x
     *            the evaluation point.
    ...
    public double evaluate(double x, double epsilon, int maxIterations) throws MathException {
        ...
        while (n < maxIterations && relativeError > epsilon) {
            ...
            if (Double.isInfinite(p2) || Double.isInfinite(q2)) { // changed calculation
                ...
                if (execute(NEW)) {
                    /*
                     * Need to scale. Try successive powers of the larger of a or b up to 5th power. Throw
                     * ConvergenceException if one or both of p2, q2 still overflow.
                     */
        ...
        if (n >= maxIterations) {
            throw new MaxIterationsExceededException(maxIterations,
                    "Continued fraction convergents failed to converge for value {0}", x);
        }
