...
public class Gamma1 {
        ...
        throws MathException
    {
        ...
        if (Double.isNaN(a) || Double.isNaN(x) || (a <= 0.0) || (x < 0.0)) {
            ...
            ret = 0.0;
        } else if (x >= a + 1) { // changed expression: (a >= 1.0 && x > a) -> (x >= a + 1)
            ...
            while (Math.abs(an/sum) > epsilon && n < maxIterations && sum < Double.POSITIVE_INFINITY) {
                // changed expor: old (Math.abs(an) > epsilon && n < maxIterations)
            ...
            } else if (Double.isInfinite(sum)) { // changed added branch
                ret = 1.0;
            } else {
        ...
        throws MathException
    {
        ...
        if (Double.isNaN(a) || Double.isNaN(x) || (a <= 0.0) || (x < 0.0)) {
            ...
            ret = 1.0;
        } else if (x < a + 1.0) { // changed expression: (x < a || a < 1.0) -> (x < a + 1.0)
