...
import test.org.apache.commons.math.special.Erf0;
 ...
 */
public class NormalDistributionImpl0 extends AbstractContinuousDistribution
     ...
     */
    public NormalDistributionImpl0(double mean, double sd){
        super();
        setMean(mean);
     ...
     */
    public NormalDistributionImpl0(){
        this(0.0, 1.0);
    }
    ...
    public double cumulativeProbability(double x) throws MathException {
        try {
            return 0.5 * (1.0 + Erf0.erf((x - mean) /
