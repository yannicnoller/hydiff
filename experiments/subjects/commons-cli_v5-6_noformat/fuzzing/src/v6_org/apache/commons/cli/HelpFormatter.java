...
public class HelpFormatter {
     ...
     * Defaults to case-insensitive alphabetical sorting by option key
     */
    public Comparator getOptionComparator() // changed: added method
    {
     ...
     */
    public void setOptionComparator(Comparator comparator) // changed: added method
    {
        if ( comparator == null ) 
        {
                           ...
                           Options options)
    {
        ...
        Collections.sort(optList, getOptionComparator() ); // changed: sort first
                                     ...
                                     final boolean required)
    {
        ...
        if (option.hasArg() && option.hasArgName()) // changed: condition
        {
                                             ...
                                             int nextLineTabStop, String text)
    {
        ...
        while (true)
        {
            ...
            pos = findWrapPos(text, width, 0); // changed: last parameter
