...
public abstract class Parser implements CommandLineParser {
    ...
    protected void setOptions(final Options options) { // changed: added method
        this.options = options;
        this.requiredOptions = new ArrayList(options.getRequiredOptions());
    }

    protected Options getOptions() { // changed: added method
        return options;
    }

    protected List getRequiredOptions() { // changed: added method
        ...
        throws MissingOptionException
    {
        ...
        if (getRequiredOptions().size() > 0)
        {
            ...
            StringBuffer buff = new StringBuffer("Missing required option"); // changed: new string
            buff.append(getRequiredOptions().size() == 1 ? "" : "s"); // changed: added stmt
            buff.append(": "); // changed: added stmt
            ...
            throw new MissingOptionException(buff.substring(0, buff.length() - 2)); // changed: cutted at the end
        }
    }
