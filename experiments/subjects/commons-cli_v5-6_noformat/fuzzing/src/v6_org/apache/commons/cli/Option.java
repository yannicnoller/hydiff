 ...
 *
 * @see v6_org.apache.commons.cli.Options
 * @see v6_org.apache.commons.cli.CommandLine
 *
...
public class Option implements Cloneable, Serializable {
           ...
           throws IllegalArgumentException
    {
        ...
        // changed: removed stmt to init hasArg because var deleted
   ...
   /** 
    ...
    {
        return hasNoValues()
               ? null : (String[]) this.values.toArray(new String[this.values.size()]); // changed: init String size
    }
    ...
    public String toString()
    {
        ...
        if (hasArgs()) // changed: condition
        {
            buf.append("[ARG...]"); // changed: values
        } else if (hasArg()) { // changed: condition
            buf.append(" [ARG]");
        }
     ...
     */
    public Object clone() { // changed: added method
        try {
     ...
     */
    void clearValues() { // changed: added method
        this.values.clear();
    }
     ...
     */
    public boolean addValue(String value) { // changed: introduced error
