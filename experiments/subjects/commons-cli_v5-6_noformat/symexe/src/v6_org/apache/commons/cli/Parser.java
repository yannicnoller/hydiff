 ...
 */
package v6_org.apache.commons.cli;
...
public abstract class Parser implements CommandLineParser {
    ...
    /**
     * <p>
     * Subclasses must implement this method to reduce the <code>arguments</code> that have been passed to the parse
     * method.
     * </p>
     *
     * @param opts
     ...
     *            specifies whether to stop flattening when a non option has been encountered
     ...
     *            the <code>arguments</code>
     * @param stopAtNonOption
     *            specifies whether to stop interpreting the arguments when a non option has been encountered and to add
     ...
     *            command line option name-value pairs
     * @param stopAtNonOption
     *            stop parsing the arguments when the first non option is encountered.
     *
     * @return the list of atomic option and value tokens
     *
     * @throws ParseException
    ...
    protected void checkRequiredOptions() throws MissingOptionException {
        ...
        if (getRequiredOptions().size() > 0) {
            ...
            throw new MissingOptionException(buff.substring(0, change(buff.length(), buff.length() - 2))); 
        }
    }

    /**
     * <p>
     * Process the argument values for the specified Option <code>opt</code> using the values retrieved from the
    ...
    /**
     * <p>
     * Process the Option specified by <code>arg</code> using the values retrieved from the specfied iterator
     * <code>iter</code>.
     *
     * @param arg
     ...
     *
     * @throws ParseException
     *             if <code>arg</code> does not represent an Option
     */
