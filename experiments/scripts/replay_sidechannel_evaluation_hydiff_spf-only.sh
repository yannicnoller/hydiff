...
total_number_experiments=$(( $total_number_subjects * $(($number_of_runs * 1)))) #3 because of fuzzing+symexe+hybrid
...
## WORKING DIR
cd "/home/ladmin/projects/blazer_login_unsafe"
...
do
  ...
  # Evaluate run
  python3 /home/ladmin/projects/hydiff/regression-experiments/evaluate_cost_hydiff_spf.py ${subjects[i]}/hydiff-out- $number_of_runs $time_bound $step_size_eval
