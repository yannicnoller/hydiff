...
do
  ...
  # Evaluate run
  python3 /home/ladmin/projects/hydiff/regression-experiments/evaluate_regression_hydiff_spf.py ${subjects[i]}/hydiff-out- $number_of_runs $time_bound $step_size_eval
