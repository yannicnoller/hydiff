...
if __name__ == '__main__':
    ...
    outputFileName = fuzzerOutDir[0:fuzzerOutDir.rfind("/")+1] + "hydiff-afl+spf-" + "results-n=" + str(NUMBER_OF_EXPERIMENTS) + "-t=" + str(EXPERIMENT_TIMEOUT) + "-s=" + str(STEP_SIZE) + ".csv"
    ...
    with open(outputFileName, "w") as csv_file:
        ...
        csv_file.write("\nWe do not report times because we make so sense here!")
